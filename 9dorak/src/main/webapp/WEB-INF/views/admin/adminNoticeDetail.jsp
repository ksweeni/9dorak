	...
	<div class=e2099_2373>
		...
		<div class="e2099_2486">
			...
			<div id="noticeTable" class="table-container">
				...
				<div class="top">
				<div class="top-title"><p class="top-title-p">공지사항 수정 및 삭제 </p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path d="M12 20H21" stroke="#F49B33" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16.5 3.50023C16.8978 3.1024 17.4374 2.87891 18 2.87891C18.2786 2.87891 18.5544 2.93378 18.8118 3.04038C19.0692 3.14699 19.303 3.30324 19.5 3.50023C19.697 3.69721 19.8532 3.93106 19.9598 4.18843C20.0665 4.4458 20.1213 4.72165 20.1213 5.00023C20.1213 5.2788 20.0665 5.55465 19.9598 5.81202C19.8532 6.06939 19.697 6.30324 19.5 6.50023L7 19.0002L3 20.0002L4 16.0002L16.5 3.50023Z" stroke="#F49B33" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
</svg></div>
<hr class="hr-line" />
</div>
<div class="contents">
					공지사항 번호 <input type="text" value="${anno.anno_no }" id="anno_no"
						class="notice-input" /> <br /> 공지사항 제목<input class="notice-input"
						type="text" value="${anno.anno_title }" id="anno_title" /> <br />
					공지사항 내용
					...
					<br /> 공지사항 조회수<input class="notice-input" type="text"
						...
						<div class="date-wrapper">공지사항 등록날짜 <input
						class="notice-date" type="date" value="${anno.anno_date}" /></div> <br />
						</div>
				</form>
			</div>
