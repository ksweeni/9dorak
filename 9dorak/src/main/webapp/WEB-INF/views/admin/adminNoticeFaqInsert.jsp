		...
		<div class="e2099_2486">
			...
			<div id="noticeTable" class="table-container">
				...
				<form action="" class="notice-form">
					<div class="top">
						<div class="top-title">
							<p class="top-title-p">신규 FAQ 등록</p>
...
<path
					...
					<div class="contents">
						FAQ 제목 <input type="text" id="faq_title" class="notice-input" />
						FAQ 내용
						<textarea id="faq_cont" class="notice-text"></textarea>
					</div>

				</form>
			</div>
			<div class="button-wrapper" style="top: 8rem;">
				<button id="noticeFaqInsert" class="update-button">등록하기</button>
			</div>
