...
<path
			...
			<div class="table-wrapper">
				<table id="products" border="1">
					...
					<thead>
						<tr>
							<th style="border-radius: 10px 0px 0px 0px;">메뉴번호</th>
							<th>메뉴이름</th>
							<th>메뉴가격</th>
							<th>메뉴등록날짜</th>
							<th>메뉴알레르기</th>
							...
							<th>메뉴칼로리</th>
							<th>메뉴중량</th>
							<th style="border-radius: 0px 10px 0px 0px;">메뉴재고</th>
						</tr>
					</thead>
					<tbody>
