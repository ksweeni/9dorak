...
<link rel="stylesheet" href="${cpath}/resources/css/styleguide.css"
	type="text/css" />
<link rel="stylesheet"
	href="${cpath}/resources/css/adminMemberInsertStyle.css?d" type="text/css" />
<meta charset="UTF-8">
...
<body>
	<div class=e2099_2373>
		...
		<button type="submit" class="insert_member" id="insert">회원 추가하기</button>
		<button type="submit" class="member_check" id="idCheck">ID 중복확인</button>
		</div>
		<div class="e2099_2487">
		<div class="e2099_2490"><p><b>1. 회원 기본 정보</b></p>
		회원이름 <br> 
		<input type="text" value="${detailmem.mem_name}" id="mem_name" name="mem_name" placeholder="회원명 입력"></input>
		<br><br>
		회원생년월일 <br> 
		<input type="date" value="${detailmem.mem_bd}" id="mem_bd" name="mem_bd" placeholder="회원생년월일 입력"></input>
		<br><br>
		회원이메일<br> 
		<input type="text" value="${detailmem.mem_email}" id="mem_email" name="mem_email" placeholder="회원이메일 입력"></input>
		<br><br>
		회원전화번호 <br> 
		<input type="text" value="${detailmem.mem_phone}" id="mem_phone" name="mem_phone" placeholder="띄어쓰기없이 11자리"></input>
		</div>
		<div class="e2099_2491"><p><b>2. 회원 구도락 정보</b></p>
		회원ID <br> 
		<input type="text" value="${detailmem.mem_id}" id="mem_id" name="mem_id" placeholder="회원ID 입력"></input>
		<br><br>
		회원PW <br> 
		<input type="text" value="${detailmem.mem_pw}" id="mem_pw" name="mem_pw" placeholder="회원password 입력"></input>
		<br><br>
		회원코드 <br> 
		<input type="text" value="${detailmem.mem_code}" id="mem_code" name="mem_code" placeholder="회원코드 입력"></input>
		<br><br>
		회원포인트 <br> 
		<input type="text" value="${detailmem.mem_point}" id="mem_point" name="mem_point" placeholder="회원포인트 입력"></input>
		<br><br>
		회원등급 <br> 
		<input type="text" value="${detailmem.mem_grade}" id="mem_grade" name="mem_grade" placeholder="낑깡, 귤, 오렌지, 한라봉 중 입력"></input>
		<br><br>
		회원탈퇴여부 <br> 
		<input type="text" value="${detailmem.mem_quit}" id="mem_quit" name="mem_quit" placeholder="0 혹은 1 입력"></input>
		<br><br>
		회원이미지 <br> 
		<input type="text" value="${detailmem.mem_image}" id="mem_image" name="mem_image" placeholder="회원이미지 경로 입력"></input>
		</div>
		</div>
		</form>
		</div>
