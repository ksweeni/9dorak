						...
						<%-- 							<div class="property-default">
								<div class="overlap-group-6">
									...
									<div class="group-15">
										...
										<div class="group-16">
											<img class="vector" src="../resources/images/event/star.png" />
											<div class="text-wrapper-10">${clistlike[0].challengelike_cnt}</div>
										</div>
									</div>
								</div>
							</div>
							<div class="property-default-2">
								<div class="overlap-group-6">
									...
									<div class="group-15">
										...
										<div class="group-16">
											<img class="vector" src="../resources/images/event/9make09.png" />
											<div class="text-wrapper-10">${clistlike[1].challengelike_cnt}</div>
										</div>
									</div>
								</div>
							</div>
							<div class="property-default-3">
								<div class="overlap-group-6">
									...
									<div class="group-15">
										...
										<div class="group-16">
											<img class="vector" src="../resources/images/event/9make09.png" />
											<div class="text-wrapper-10">${clistlike[2].challengelike_cnt}</div>
										</div>
									</div>
								</div>
							</div>
							<div class="property-default-4">
								<div class="overlap-group-6">
									...
									<div class="group-15">
										<div class="frame-2">
											<div class="text-wrapper-8">${clist[3].mem_id}</div>
											<div class="text-wrapper-9">${clist[3].challenge_name}</div>
										</div>
										<div class="group-16">
											<img class="vector" src="../resources/images/event/star.png" />
											<div class="text-wrapper-10">${clistlike[3].challengelike_cnt}</div>
										</div>
									</div>
								</div>
							</div>
							<div class="property-default-5">
								<div class="overlap-group-6">
									...
									<div class="group-15">
										<div class="frame-2">
											<div class="text-wrapper-8">${clist[4].mem_id}</div>
											<div class="text-wrapper-9">${clist[4].challenge_name}</div>
										</div>
										<div class="group-16">
											<img class="vector" src="../resources/images/event/9make09.png" />
											<div class="text-wrapper-10">${clistlike[4].challengelike_cnt}</div>
										</div>
									</div>
								</div>
							</div>
							<div class="property-default-6">
								<div class="overlap-group-6">
									...
									<div class="group-15">
										<div class="frame-2">
											<div class="text-wrapper-8">${clist[5].mem_id}</div>
											<div class="text-wrapper-9">${clist[5].challenge_name}</div>
										</div>
										<div class="group-16">
											<img class="vector" src="../resources/images/event/9make09.png" />
											<div class="text-wrapper-10">${clistlike[5].challengelike_cnt}</div>
										</div>
									</div>
								</div>
							</div> --%>
