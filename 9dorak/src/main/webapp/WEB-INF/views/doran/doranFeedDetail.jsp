...
<link rel="stylesheet" href="${cpath}/resources/css/styleguide.css?d"
	type="text/css" />
<link rel="stylesheet" href="${cpath}/resources/css/doranFeedDetailStyle.css?e"
	type="text/css" />
<meta charset="UTF-8">
    ...
    <div class="div-wrapper">
      <div class="div">
        ...
        <header class="header">
          <div class="top-nav">
            <div class="navbar">
              <div class="text-wrapper">메뉴보기</div>
              <div class="text-wrapper-2">구독하기</div>
              <div class="text-wrapper-3">요모조모</div>
              <div class="text-wrapper-4">도란도란</div>
            </div>
            <img class="untitled" src="img/untitled-1-1.png" />
            <div class="group">
              <div class="text-wrapper-5">로그인 | 회원가입</div>
              <div class="overlap-group-wrapper">
                <div class="overlap-group">
                  <img class="img" src="img/group-1.svg" />
          ...
          <div class="feeds">
            <div class="group-3">
              <div class="overlap-group-2">
                <img class="unsplash" src="${cpath }/resources/upload/${doran.doran_image}" />
                ...
                <div class="group-4">
                  ...
                  <div class="frame-2">
                    ...
                    <div class="group-5"><div class="text-wrapper-12">8분전</div></div>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div class="reply">
                          ...
                          <div class="message">
                            <div class="overlap-group-3">
                              <div class="text"><div class="text-wrapper-15">Here’s some feedback...</div></div>
                ...
                <div class="group-6">
                  <div class="overlap-2">
                    <div class="input-comments">
                      <img class="unsplash-upihhsyew" src="img/unsplash-u3pi6hhsyew.svg" />
                      <div class="textzone">
                        <div class="overlap-group-4"><div class="text-wrapper-17">자유롭게 작성해 보세요 ..</div></div>
                      </div>
                      <div class="group-wrapper">
                        <div class="group-7">
                          <div class="overlap-group-5">
                            ...
                            <img class="carbon-send-alt" src="img/carbon-send-alt-filled.svg" />
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="group-11">
          <div class="group-12">
            <div class="overlap-group-6">
              <div class="card">
                <div class="frame-7">
                  <div class="ellipsis-wrapper"><div class="ellipsis">􀍠</div></div>
                </div>
                <div class="tab">
          ...
          <div class="group-13">
	            <div class="overlap-3">
	              <input class="text-wrapper-23" id=searchTxt type="text" placeholder="검색어를 입력하세요"/>
	            </div>
          ...
          <div class="company-loco">
            <div class="company">
              <p class="text-wrapper-24">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Commodo libero viverra dapibus odio sit
                malesuada in quis. Arcu tristique elementum viverra integer id.
              </p>
              <img class="untitled-2" src="img/untitled-1-2.png" />
            </div>
            <div class="social-icon">
              <div class="facebook"><img class="mask-group" src="img/mask-group.png" /></div>
              <div class="instagram"><img class="mask-group-2" src="img/image.png" /></div>
              <div class="twitter"><img class="mask-group-3" src="img/mask-group-2.png" /></div>
              <div class="linkind"><img class="mask-group-3" src="img/mask-group-3.png" /></div>
            </div>
          </div>
          <div class="contact-us">
            ...
            <div class="group-15">
              <div class="overlap-group-7">
                <div class="vector-wrapper"><img class="vector-3" src="img/image.svg" /></div>
