...
.e106_322 { 
	...
	left:0px;
	top:0px;
	background-image:url(${cpath}/resources/images/register/untitled_1_1.png);
...
.106_422 { 
	border:1px solid rgba(231.62500709295273, 231.62500709295273, 231.62500709295273, 1);
}
.e106_423 { 
	color:rgba(0, 0, 0, 1);
...
.e106_466 { 
	...
	left:0px;
	top:0px;
	background-image:url(${cpath}/resources/images/register/untitled_1_2.png);
	background-repeat:no-repeat;
	background-size:cover;
}
.e106_467 { 
			...
			<div class=e106_393>
				...
				<div class=e106_412>
					...
					<div class=e106_397>
						...
						<span class="e106_399">이메일인증</span>
					</div>
				</div>
				<div class=e106_409>
...
<!-- 					<div class="e106_457"></div> -->
					...
					<span class="e106_458">고객님과 추천인 모두에게 구도락 포인트를 드려요!</span><span
						class="e106_459">추천인</span>
				</div>
				<div class=e106_394>
