...
<link rel="stylesheet" href="${cpath}/resources/css/styleguide.css"
	type="text/css" />
<link rel="stylesheet" href="${cpath}/resources/css/noticeStyle.css?s"
	type="text/css" />
<meta charset="UTF-8">
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				<c:forEach var="anno" items="${annolist}" varStatus="rowStatus">
					<tr>
						<td
							onclick="location.href ='${pageContext.request.contextPath}/yomo/noticeDetail.do?anno_no=' + ${anno.anno_no}">${anno.anno_no}</td>
						<td
							onclick="location.href ='${pageContext.request.contextPath}/yomo/noticeDetail.do?anno_no=' + ${anno.anno_no}">${anno.anno_title}</td>
						<td
							onclick="location.href ='${pageContext.request.contextPath}/yomo/noticeDetail.do?anno_no=' + ${anno.anno_no}">${anno.anno_date}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
