...
<link rel="stylesheet" href="${cpath}/resources/css/styleguide.css"
	type="text/css" />
<link rel="stylesheet" href="${cpath}/resources/css/myDelivery_ajaxStyle.css?d"
	type="text/css" />
...
<body>
	<div class="e128_186">
			...
			<div class="e128_218">
				...
				<c:forEach var="item" items="${dlist}">
					<div class="e126_328">
						<div class="e126_327">
							<div class="e126_320">
								<span class="e126_322">${item.mem_delname}</span>
		...
		<div class=e125_204>
			<span class="e125_205">배송지 관리</span>
			<span class="e125_206">배송지 관리</span>
