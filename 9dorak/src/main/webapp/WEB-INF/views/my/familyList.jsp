...
<path fill-rule="evenodd" clip-rule="evenodd"
					...
					<div class="text-8">지인 목록 조회</div>
				</div>
			</div>
			<h1 class="text-9"
				style="margin-top: 52px; font-weight: unset; position: relative; top: 10px;">지인
				목록 조회</h1>
		</div>
		<div class="overlap-group2">
			<div class="menu">
				<div class="username">
					...
					<div class="flex-col">
						<div class="text-3 valign-text-middle">${loginmem.mem_id }</div>
				...
				<div class="links">
					...
					<div class="privacy-2 privacy-3">
						<div class="text-5 valign-text-middle">지인 목록 조회</div>
					</div>
				</div>
			</div>
		</div>
