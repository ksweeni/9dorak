...
.e145_1497 {
	...
	position: absolute;
	left: 167.841797px;
	top: -2px; background-image :
	url(${cpath}/resources/images/my/image_8.png); background-repeat :
	no-repeat; background-size : cover; position : absolute; left :
	167.841797px; top : -2px; background-image :
	url(${cpath}/resources/images/my/image_8.png);
	background-repeat: no-repeat;
	left: 167.841797px;
	top: -2px;
		...
		<div class=e145_1493>
			...
			<div class=e145_1499>
				<div class=e145_1500>
					...
					<a href="${cpath }/menu/menuSpecificReview.do?pro_no=${item.pro_no}">
							<div class="e145_1565">
								<div class="e145_1566">
									<div class="e145_1567">
