		...
		<div class="div">
			...
			<div class=e1433_2555>
				<span class="e1433_2556"> <a
					href="${pageContext.request.contextPath}/menu/menu.do"
					style="color: white; text-decoration: none;"> <span>전체
							메뉴 보기</span>
				</a>
				</span>
			</div>
				...
				<div id="carouselExampleControls" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="${cpath}/my/familyReg.do"> <img
								src="${cpath}/resources/images/main/main_family.png"
								class="d-block w-100" alt="...">
							</a>
						</div>
						<div class="carousel-item">
							<a href="${cpath}/event/makelunchbox.do"> <img
								src="${cpath}/resources/images/main/makeLunch.png"
								class="d-block w-100" alt="...">
							</a>
						</div>
						<div class="carousel-item">
						...
						<div class="carousel-item">
							<a href="${cpath}/menu/menu.do"> <img
								src="${cpath}/resources/images/main/main_menu.png"
								class="d-block w-100" alt="...">
							</a>
						</div>
						<div class="carousel-item">
							<a href="${cpath}/my/familyReg.do"> <img
								src="${cpath}/resources/images/main/main_friend.png"
								class="d-block w-100" alt="...">
							</a>
						</div>
					</div>
