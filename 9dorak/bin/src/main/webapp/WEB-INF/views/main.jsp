...
<link rel="stylesheet" href="${cpath}/resources/css/mainStyle.css?e"
	type="text/css" />
...
<body>
			...
			<header class="header">
				<div class="top-nav">
					...
					<div class="div-3">
						...
						<div class="group-20" id="basket" onclick="loginBasket()">
	...
	<script type="text/javascript">
		...
		function lightsOn() {
			...
			ellipseDiv.setAttribute("id","lightsOnID");
			document.querySelector("#basket");
		}
		
		function lightsInheritance() {
			lightsOn();
			var lights = document.getElementById('lightsOnID');
		    if (lights) {
		    	lights.classList.add('div3', 'group20');
		    }
		}
